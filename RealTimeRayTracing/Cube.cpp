...
Cube::Cube(Pos3 pos, float width, float height, float depth)
{
	this->pos    = pos;
	this->width  = width;
	this->height = height;
...
void Cube::render(bool matrixReset)
{
	if(shader == NULL)
	{
...
void Cube::constructGeometry(Shader* myShader)
{
	...
	//-----------X--------------	--------------Y--------------	--------------Z-------------
	verts[ 0] = pos.x+halfWidth;	verts[ 1] = pos.y-halfHeight;	verts[ 2] = pos.z-halfDepth;
	verts[ 3] = pos.x+halfWidth;	verts[ 4] = pos.y+halfHeight;	verts[ 5] = pos.z-halfDepth;
	verts[ 6] = pos.x-halfWidth;	verts[ 7] = pos.y+halfHeight;	verts[ 8] = pos.z-halfDepth;
	verts[ 9] = pos.x-halfWidth;	verts[10] = pos.y-halfHeight;	verts[11] = pos.z-halfDepth;
...
void Cube::setDimetions(float width, float height, float depth)
{
	this->width  = width;
	this->height = height;
	this->depth  = depth;
