...
bool Shader::load(const std::string name, const char* vertexFilename, const char* fragmentFilename)
{
	...
	if(!success)
	{
		std::cerr << std::endl << "Error compiling GLSL vertex shader: '" << vertexFilename << "'" << std::endl << std::endl;
		std::cerr << "Shader info log:" << std::endl << shaderInfoLog(m_vertexShader) << std::endl;
	...
	else
	{
		...
		if(!success)
		{
			std::cerr << std::endl << "Error compiling GLSL fragment shader: '" << fragmentFilename << "'" << std::endl << std::endl;
			std::cerr << "Shader info log:" << std::endl << shaderInfoLog(m_fragmentShader) << std::endl;
		...
		else
		{
			...
			if(!success)
			{
				...
				std::cerr << "Program info log:" << std::endl << programInfoLog(m_programObject) << std::endl;
